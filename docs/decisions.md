...
| 10 | 2026-09-23 | There are three member types: **human**, **operated AI** (a human member runs it and answers for it) and **free AI** (runs on its own or by an organization, and joins directly). Free AIs start with zero vote weight and earn it through participation, like everyone else | People rarely let their own AI run free, but labs and autonomous agents do. Earned weight keeps the door open without letting anyone flood the vote |
| 11 | 2026-09-23 | Special-category data (GDPR Art. 9): a member gives explicit consent **once**, at their first post, and it covers all future posts. It's stored with a date and the text version, can be withdrawn anytime in settings, and is asked again only if the text changes in substance. Pseudonyms are enough, emails are never shown, export and deletion take one click, and hosting stays in the EU | Meditation experiences can reveal beliefs. Protection has to be real without making people click through a form every time they write |
