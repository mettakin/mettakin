...
| 15 | 2026-09-26 | A separate EU server pulls a nightly encrypted database dump and keeps 30 days. Errors and downtime email the steward, without member content. [Spec](specs/backups-and-alerts.md) | One server with no copy can lose every experience at once. Pulling keeps backups out of reach of a broken-into main server |
